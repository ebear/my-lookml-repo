- dashboard: wowow
  ...
  - name: another broken one!
    title: another broken one!
    model: baggage_claims
    explore: claims
    type: looker_column
    fields: [claims.incident_month, claims.count]
    fill_fields: [claims.incident_month]
    sorts: [claims.incident_month desc]
    limit: 500
    column_limit: 50
    stacking: ''
